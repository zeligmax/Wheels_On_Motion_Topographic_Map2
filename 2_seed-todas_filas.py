...
# Calcular la semilla a partir de los datos (sin Timestamp)
# Por ejemplo, suma de Latitud, Longitud, Altitud, Ax, Ay, Az
cols = ['Latitud', 'Longitud', 'Altitud', 'Ax', 'Ay', 'Az']
seed_val = int(np.sum([df[c].sum() for c in cols]) * 1e6) % (2**32 - 1)
